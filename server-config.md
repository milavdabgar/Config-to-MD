...
server {
	...
	# Add index.php to the list if you are using PHP
	index index.html index.htm index.nginx-debian.html;
        server_name gpplmsv1.planetmilav.com nextcloud.planetmilav.com mail.planetmilav.com; # managed by Certbot
...
server {
	...
	listen 80 ;
	listen [::]:80 ;
    server_name gpplmsv1.planetmilav.com nextcloud.planetmilav.com mail.planetmilav.com;
...
#  -o smtpd_milters=unix:/var/spool/postfix/opendkim/opendkim.sock
...
ssl_cert = </etc/letsencrypt/live/mail.planetmilav.com/fullchain.pem
ssl_key = </etc/letsencrypt/live/mail.planetmilav.com/privkey.pem
...
# Custom Setup for compatibility with old devices
...
[Public-RO]
    ...
    path = /home/milav/Samba/Public-RO
    browsable = yes
    guest ok = yes
    read only = yes
